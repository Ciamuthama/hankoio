  ...
  return (
    <div className="flex justify-between flex-col h-full mb-auto">
      <div className="lg:bg-neutral-400/50 md:bg-none max-sm:bg-none flex justify-between items-center flex-row font-sans">
        ...
        <div
          className={"flex flex-col md:justify-between lg:bg-neutral-900 p-1 lg:gap-4  max-sm:gap-6 mx-auto lg:w-3/5 md:w-2/3 max-sm:w-auto max-sm:h-4/5 rounded lg:shadow-[0_0_10px_3px_rgba(67,67,67,0.4)]  "}
        >
